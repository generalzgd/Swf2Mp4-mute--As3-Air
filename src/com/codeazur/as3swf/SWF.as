package com.codeazur.as3swf
{
	...
	public class SWF extends SWFTimelineContainer
	{
		...
		public function getFileAttributesTag():ITag
		{
			for each(var it:ITag in tags)
			{
				if(it.type == TagFileAttributes.TYPE)
				{
					return it;
				}
			}
		...
		public function getBackgroundColorTag():ITag
		{
			for each(var it:ITag in tags)
			{
				if(it.type == TagSetBackgroundColor.TYPE)
				{
					return it;
				}
			}
